...
export default function Navbar() {
  return (
    <nav style={{ display: 'flex', justifyContent: 'space-between', padding: '20px 50px', backgroundColor: 'white' }}>
      ...
      <div style={{ display: 'flex', gap: '30px' }}>
        ...
        <Link to="/home" style={{ textDecoration: 'none', color: '#64748b' }}>Book Slot</Link>
      </div>
    </nav>
  );
}